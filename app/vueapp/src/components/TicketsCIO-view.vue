    ...
    <v-flex md8 offset-md2>
      ...
      <v-container grid-list-md text-xs-center wrap style="margin-bottom: 15px">
        <v-layout row wrap>
          ...
          <v-flex lg6 md6>
            <v-card color="deep-orange darken-1" dark height="100%" class="adjust-flex">
              <v-card-text class="px-5 pt-5">
                <v-layout row wrap>
                  <v-flex lg12>
                    <p class="display-1">Service Level Agreement report</p>
                  </v-flex>
                </v-layout>
                <v-layout row wrap>
                  <v-flex lg6 md12>
                    <p class="title">Service/device availability</p>
                    <p class="display-2">{{ service_availability }}%</p>
                  </v-flex>
                  <v-flex lg6 md12>
                    <p class="title">Customer Satisfaction by day</p>
                    <p class="display-2">{{ customer_satisfaction }}%</p>
                  </v-flex>
                </v-layout>
              </v-card-text>
            </v-card>
...
<script>
  ...
  module.exports = {
    ...
    created: function () {
      ...
      setTimeout(() => log(_.groupBy(this.issues, 'status__value')['new']), 1000) // TODO this is start filtering by status, i'm trying =(
    }
  }
</script>
